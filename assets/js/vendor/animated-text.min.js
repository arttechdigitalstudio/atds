!(function (e, s) {
  window.lfAnimatedText = function (s) {
    s = e.extend(
      {
    ...
    var a,
      t = e(s.selector),
      n = s.animationDelay,
      l = s.barAnimationDelay,
      d = l - 3e3,
      r = s.lettersDelay,
      o = s.typeLettersDelay,
      c = s.selectionDuration,
      h = c + 800,
      p = s.revealDuration,
      u = s.revealAnimationDelay;
    function f(s) {
      var i = v(s);
      if (s.parents(".cd-headline").hasClass("type")) {
        var a = s.parent(".cd-words-wrapper");
        ...
        var t = s.children("i").length >= i.children("i").length;
        !(function s(i, a, t, l) {
          ...
          if (i.is(":last-child") && e("html").hasClass("no-csstransitions")) {
            var d = v(a);
            w(a, d);
          }
        })(s.find("i").eq(0), s, t, r),
          C(i.find("i").eq(0), i, t, r);
      } else
    ...
    function w(e, s) {
      e.removeClass("is-visible").addClass("is-hidden"),
        s.removeClass("is-hidden").addClass("is-visible");
    }
    (a = n),
      t.each(function () {
        var s = e(this);
        if (s.hasClass("loading-bar"))
          (a = l),
            setTimeout(function () {
          ...
          var n = s.find(".cd-words-wrapper b"),
            r = 0;
          n.each(function () {
            var s = e(this).width();
            s > r && (r = s);
          }),
            s.find(".cd-words-wrapper").css("width", r);
        }
        setTimeout(function () {
      ...
      t.hasClass("letters") &&
        t.find("b").each(function () {
          var s = e(this),
            a = s.text().split(""),
            t = s.hasClass("is-visible"),
            n = s.parents(".rotate-2").length;
          for (i in a) {
            var l = e.trim(a[i]) ? a[i] : "&nbsp;";
            n && (l = "<em>" + l + "</em>"),
              (a[i] = t ? '<i class="in">' + l + "</i>" : "<i>" + l + "</i>");
          }
          s.html(a.join("")).css("opacity", 1);
        });
  };
})(jQuery);
